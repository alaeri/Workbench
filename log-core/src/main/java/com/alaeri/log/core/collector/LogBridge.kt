 ...
 */
class LogBridge(private val emissionScope: CoroutineScope, replay: Int = 0, extraBuffer: Int = 0, bufferOverflow: BufferOverflow = BufferOverflow.SUSPEND): LogCollector {
