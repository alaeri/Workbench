...
import com.alaeri.ui.glide.OkHttpProgressResponseBody
import com.alaeri.ui.glide.ProgressListener
    ...
    override fun registerComponents(context : Context, glide: Glide, registry: Registry) {
        ...
        val client = OkHttpClient.Builder()
            .addNetworkInterceptor{chain ->
                ...
                val body = OkHttpProgressResponseBody(flowImageLoader, request.url(), response.body()!!)
